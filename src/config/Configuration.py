...
class Configuration:
    ...
    def getPriority(self, section, option=None):
        if section in self.priority.sections():
            return self.priority.get(section, 'priority')
        else:
            return None

    def setPriority(self, section, option, value=None):
    ...
    def saveWindowSettings(self, ui, window):
        ...
        self.config.set('WINDOW', 'section0', str(ui.treeWidget.header().sectionSize(0)))
        self.config.set('WINDOW', 'section1', str(ui.treeWidget.header().sectionSize(1)))
        self.config.set('WINDOW', 'section2', str(ui.treeWidget.header().sectionSize(2)))
        self.config.set('WINDOW', 'section3', str(ui.treeWidget.header().sectionSize(3)))
        self.config.set('WINDOW', 'section4', str(ui.treeWidget.header().sectionSize(4)))
        self.config.set('WINDOW', 'section5', str(ui.treeWidget.header().sectionSize(5)))
        self.config.set('WINDOW', 'section6', str(ui.treeWidget.header().sectionSize(6)))
        self.config.set('WINDOW', 'section7', str(ui.treeWidget.header().sectionSize(7)))
        self.config.set('WINDOW', 'section8', str(ui.treeWidget.header().sectionSize(8)))
        self.config.set('WINDOW', 'section9', str(ui.treeWidget.header().sectionSize(9)))
        self.config.set('WINDOW', 'section10', str(ui.treeWidget.header().sectionSize(10)))
        self.config.set('WINDOW', 'section11', str(ui.treeWidget.header().sectionSize(11)))
    ...
    @staticmethod
    def correctGamePath(self, gamepath=""):
        if not gamepath:
            gamepath = self.game
